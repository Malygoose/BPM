    ...
    <form id="form1" runat="server" class="center-panel">
        ...
        <asp:Panel ID="pnlDate" runat="server">
            <table width="100%">
                ...
                <tr>
                    <td width="50%">
                        <asp:Label ID="lblSelectWorking" runat="server" Text="客訴" Visible="false"></asp:Label>
        ...
        <asp:Panel ID="pnlApplyDepiction" runat="server">
            ...
            <table width="100%">
                <tr>
                    <td>
                        <asp:Label ID="lblInputProductCode" runat="server" Text="成品料號:"></asp:Label>
                        <asp:TextBox ID="txbInputProductCode" runat="server" Width="750px" placeholder="(請輸入成品料號)"></asp:TextBox>
                        ...
                        <asp:Button ID="btnClearEnter" runat="server" Text="清空" OnClick="btnClearEnter_Click" /><br />
                ...
                <table width="100%">
                    <tr>
                        ...
                        <td width="25%">
                            ...
                            <asp:TextBox ID="txbBadQty" runat="server" Width="90px" oninput="AutoBadRate()" placeholder="(請輸入數字)" TextMode="Number"></asp:TextBox>
                ...
                <table width="100%">
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:TextBox ID="txbOccurPlace" runat="server" placeholder="(請輸入發生地點)"></asp:TextBox>
                        </td>
                    </tr>
                </table>
                    ...
                    <table width="100%">
                        <tr>
                            <td width="50%">
                                ...
                                <asp:TextBox ID="txbProblemDescription" runat="server" Width="95%" Height="70px" TextMode="MultiLine" placeholder="(請輸入問題描述)"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label ID="lblMeasureDirection" runat="server" Text="已採措施說明:"></asp:Label>
                                <asp:TextBox ID="txbMeasureDirection" runat="server" Width="95%" Height="70px" TextMode="MultiLine" placeholder="(請輸入已採措施說明)"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
        ...
        <asp:Panel ID="pnlQAConfirm" runat="server"  Enabled="false">
            <asp:Label ID="lblQAConfirm" runat="server" Text="◆品保確認:" CssClass="title-style"></asp:Label><br />


            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <asp:Panel ID="pnlQAConfirmWrite" runat="server" Visible="false">
                        <asp:Label ID="lblClassification" runat="server" Text="分類:"></asp:Label>
                        <asp:DropDownList ID="ddlClassification" runat="server">
                            <asp:ListItem Value="Man" Text="人"></asp:ListItem>
                            <asp:ListItem Value="Machine" Text="機器"></asp:ListItem>
                            <asp:ListItem Value="Material" Text="材料"></asp:ListItem>
                            <asp:ListItem Value="Method" Text="方法"></asp:ListItem>
                            <asp:ListItem Value="Environment" Text="環境"></asp:ListItem>
                        </asp:DropDownList>
                        <br />
                    ...
                    <asp:GridView ID="grvQAConfirm" runat="server" AutoGenerateColumns="False" CssClass="center-gridview" Width="100%" CellPadding="2" ForeColor="#333333" GridLines="None" Font-Size="18px">
                        ...
                        <Columns>
                            <asp:BoundField DataField="sReason" HeaderText="原因">
                                <HeaderStyle Width="20%" />
                            </asp:BoundField>
                            <asp:BoundField DataField="sDirections" HeaderText="說明">
                                <HeaderStyle Width="70%" />
                            </asp:BoundField>
                            <asp:TemplateField >
                                <ItemTemplate>
                                    <asp:LinkButton ID="lbtnDelete" runat="server" CommandArgument="<%# Container.DataItemIndex %>" CommandName="ItemDelete" OnCommand="lbtnDelete_Command" Text="刪除" ></asp:LinkButton>
                                </ItemTemplate>
